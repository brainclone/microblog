...
set splitbelow
set splitright
set statusline=%<%F%m%r%h%w%=%{&fileformat}/%Y%8l/%L,%-8v(%p%%)
...
argglobal
if bufexists('NetrwTreeListing\ 1') | buffer NetrwTreeListing\ 1 | else | edit NetrwTreeListing\ 1 | endif
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists('~/prj/microblog/app/templates/index.html') | buffer ~/prj/microblog/app/templates/index.html | else | edit ~/prj/microblog/app/templates/index.html | endif
